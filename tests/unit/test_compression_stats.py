...
class TestCompressionStats:
    ...
    def _create_stats(
        self, task, source_size, dest_size, source_codec="hevc", dest_codec="h264", resolution="1920x1080", library_id=1
    ):
    ...
    def test_get_compression_stats_paginated_returns_correct_results(self):
        ...
        for i in range(5):
            ...
            self._create_stats(t, source_size=(i + 1) * 1000, dest_size=(i + 1) * 500, library_id=1)
    ...
    def test_invalid_order_column_falls_back_to_finish_time(self):
        ...
        history = History()
        result = history.get_compression_stats_paginated(order={"column": "DROP TABLE", "dir": "desc"})
    ...
    def test_valid_order_column_source_size(self):
        ...
        history = History()
        result = history.get_compression_stats_paginated(order={"column": "source_size", "dir": "asc"})
