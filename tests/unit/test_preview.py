...
class TestPreviewManager:
    ...
    @patch("compresso.libs.preview.subprocess.run")
    def test_generate_preview_falls_back_on_pipeline_failure(self, mock_run, mock_pipeline, mock_codec, mock_metrics):
    ...
    @patch("compresso.libs.preview.PreviewManager._run_plugin_pipeline")
    @patch("compresso.libs.preview.subprocess.run")
    def test_generate_preview_uses_pipeline_when_available(self, mock_run, mock_pipeline, mock_codec, mock_metrics):
