    ...
    def test_multiple_stream_types_sorted(self):
        ...
        probe = {
            "streams": [
                ...
                {"codec_type": "audio", "index": 1, "codec_name": "aac", "codec_long_name": "", "profile": ""},
                {"codec_type": "subtitle", "index": 2, "codec_name": "srt", "codec_long_name": "", "profile": ""},
                {"codec_type": "audio", "index": 3, "codec_name": "ac3", "codec_long_name": "", "profile": ""},
            ],
            "format": {},
        }
        result = format_probe_data(probe)
