...
class TestPluginTypeDataSchemaValidation:
    ...
    def test_data_schema_test_valid_data(self):
        ...
        errors = pt._PluginType__data_schema_test_data("test.plugin", "on_test", result_data, pt.data_schema)
        assert errors == []
    ...
    def test_data_schema_test_none_return(self):
        pt = self._make_plugin_type()
        errors = pt._PluginType__data_schema_test_data("test.plugin", "on_test", None, pt.data_schema)
    ...
    def test_data_schema_test_multiple_types(self):
        ...
        # str should pass
        errors1 = pt._PluginType__data_schema_test_data("test.plugin", "on_test", {"value": "hello"}, pt.data_schema)
        assert errors1 == []

        # int should also pass
        errors2 = pt._PluginType__data_schema_test_data("test.plugin", "on_test", {"value": 42}, pt.data_schema)
        assert errors2 == []

        # float should fail
        errors3 = pt._PluginType__data_schema_test_data("test.plugin", "on_test", {"value": 3.14}, pt.data_schema)
    ...
    def test_data_schema_test_children(self):
        ...
        errors_bad = pt._PluginType__data_schema_test_data("test.plugin", "on_test", result_data_bad, pt.data_schema)
