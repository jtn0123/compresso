...
class TestGpuMetricsEndpoint:
    ...
    async def test_returns_gpus_and_history(self):
        ...
        gpu_data = [
            {'index': 0, 'type': 'nvidia', 'name': 'RTX 3080',
             'utilization_percent': 55.0, 'memory_used_mb': 2048,
             'memory_total_mb': 10240, 'temperature_c': 72},
        ]
        history_data = {
            0: [
                {'utilization_percent': 50.0, 'memory_used_mb': 2000,
                 'memory_total_mb': 10240, 'temperature_c': 70, 'timestamp': 1000},
                {'utilization_percent': 55.0, 'memory_used_mb': 2048,
                 'memory_total_mb': 10240, 'temperature_c': 72, 'timestamp': 1001},
            ],
        }
