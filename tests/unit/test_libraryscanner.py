...
def _make_scanner():
    ...
    with patch('compresso.libs.libraryscanner.CompressoLogging') as mock_log, \
...
class TestScanLibraryPath:
    ...
    def test_scan_empty_directory(self, mock_exists, mock_walk, mock_frontend_cls,
                                  mock_logging, mock_plugins, mock_gc):
        mgr = _make_scanner()
        ...
        with patch.object(mgr, 'start_results_manager_thread'), \
