        ...
        <q-card>
          ...
          <q-card-section>
            ...
            >
              ...
              />
              <!-- Mini-Map -->
              <canvas v-if="showMiniMap" ref="sourceMiniMapRef" class="mini-map" width="120" height="80" />
            </div>
          </q-card-section>
        </q-card>
      </div>
        ...
        <q-card>
          ...
          <q-card-section>
            ...
            >
              ...
              />
              <!-- Mini-Map -->
              <canvas v-if="showMiniMap" ref="encodedMiniMapRef" class="mini-map" width="120" height="80" />
            </div>
          </q-card-section>
        </q-card>
      </div>
    ...
    <q-card class="q-mt-md" v-if="sourceSize > 0 && encodedSize > 0">
      <q-card-section>
        <div class="text-center">
          <span class="text-h6"> {{ formatBytes(sourceSize) }} &rarr; {{ formatBytes(encodedSize) }} </span>
          <q-badge class="q-ml-md text-h6" :color="savings > 0 ? 'positive' : 'negative'">
...
export default {
  ...
  setup(props) {
    ...
    function drawMiniMap(canvasRef, videoRef) {
      ...
      ctx.lineWidth = 1.5
      ctx.strokeRect(Math.max(0, Math.min(120 - rectW, rectX)), Math.max(0, Math.min(80 - rectH, rectY)), rectW, rectH)
    }
