...
class ComparisonCandidateSchema(BaseSchema):
    ...
    output_path = fields.Str(dump_default="")
    output_url = fields.Str(dump_default="")
    output_size = fields.Int(dump_default=0)
    source_size = fields.Int(dump_default=0)
    size_saved_bytes = fields.Int(dump_default=0)
    size_saved_percent = fields.Float(dump_default=0)
    vmaf_score = fields.Float(allow_none=True, dump_default=None)
    ssim_score = fields.Float(allow_none=True, dump_default=None)
    error = fields.Str(allow_none=True, dump_default=None)
...
class ComparisonStatusResponseSchema(BaseSuccessSchema):
    ...
    source_path = fields.Str(required=True)
    source_size = fields.Int(dump_default=0)
    source_url = fields.Str(dump_default="")
    library_id = fields.Int(required=True)
    start_time = fields.Float(required=True)
    duration = fields.Float(required=True)
    status = fields.Str(required=True)
    progress = fields.Float(required=True)
    winner_candidate_id = fields.Int(allow_none=True, dump_default=None)
    full_encode_task_id = fields.Int(allow_none=True, dump_default=None)
    error = fields.Str(allow_none=True, dump_default=None)
